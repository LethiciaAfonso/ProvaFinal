...
public class RegistroVenda extends Tela implements LeituraDados {
    private Repository<Model> repoProdutos;

    public RegistroVenda(String paramString, int paramInt, Repository<Model> paramRepositorio) {
    ...
    public Model lerDados(Scanner paramScanner) {
        ...
        while (true) {
            int j;
            boolean bool = true;
            ContInput.obterInstancia().limparTela();
            System.out.println("*************");
            ...
            if (produto == null) {
                ...
                System.out.printf(
                        "\nProduto localizado: [%s]. Confirma (\"S\" ou ENTER confirma; outro caractere volta a busca)? ",
                        new Object[] { produto
                ...
                if (produto.getQuantidadeEstoque() < i) {
                    System.out.printf(
                            ...
                            new Object[] { Integer.valueOf(produto.getQuantidadeEstoque()) });
                    paramScanner.nextLine();
                    bool = false;
                }
            }
