...
public class Venda implements Model, Comparable<Venda> {
    ...
    public String toString() {
        return String.format("Data: %s - Produto: [%s] - Quantidade: %d",
                new Object[] { this.data, this.produto.toString(), Integer.valueOf(this.quantidade) });
    }
