...
public class RelatoriodeVD extends Telas implements TelaExibicaoDados {
  protected final DateTimeFormatter df = DateTimeFormatter.ofPattern("dd/MM/yyyy");
  
  public RelatoriodeVD(String paramString, int paramInt) {
    super(paramString, paramInt);
  }
  
  public void exibirDados(Scanner paramScanner, Repository<Model> paramRepositorio) {
